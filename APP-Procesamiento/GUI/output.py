...
from Funciones.migrated_image_plot import plot_migrated_image_from_merged_file
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_backgroundSubstraction = QtWidgets.QGroupBox(self.groupBox_procesado)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.groupBox_backgroundSubstraction.setFont(font)
        self.groupBox_backgroundSubstraction.setObjectName("groupBox_bacgroundSubstarction")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.groupBox_backgroundSubstraction)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.pushButton_backgroundSubstraction = QtWidgets.QPushButton(self.groupBox_backgroundSubstraction)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        self.pushButton_backgroundSubstraction.setFont(font)
        self.pushButton_backgroundSubstraction.setObjectName("pushButton_backgroundSubstraction")
        self.gridLayout_4.addWidget(self.pushButton_backgroundSubstraction, 1, 1, 1, 1)
        ...
        self.label_backgroundFile = QtWidgets.QLabel(self.groupBox_backgroundSubstraction)
        ...
        self.lineEdit_backgroundPath = QtWidgets.QLineEdit(self.groupBox_backgroundSubstraction)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.toolButton_backgroundFilePath = QtWidgets.QToolButton(self.groupBox_backgroundSubstraction)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.gridLayout_6.addWidget(self.groupBox_backgroundSubstraction, 2, 1, 1, 1)
        ...
        self.gridLayout_17.addWidget(self.groupBox_cscan, 2, 0, 1, 1)
        ...
        self.groupBox_migratedImagePlot = QtWidgets.QGroupBox(self.groupBox_grafico)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.groupBox_migratedImagePlot.setFont(font)
        self.groupBox_migratedImagePlot.setObjectName("groupBox_migratedImagePlot")
        self.pushButton = QtWidgets.QPushButton(self.groupBox_migratedImagePlot)
        ...
        self.gridLayout_17.addWidget(self.groupBox_migratedImagePlot, 2, 1, 1, 1)
        ...
        self.pushButton_backgroundSubstraction.clicked.connect(self.execBackgroundSubstraction)
        ...
        self.pushButton.clicked.connect(self.execMigratedImagePlot)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Procesamiento y Gráfica"))
        ...
        self.groupBox_backgroundSubstraction.setTitle(_translate("MainWindow", "Background Substraction"))
        self.pushButton_backgroundSubstraction.setText(_translate("MainWindow", "Ejecutar"))
        ...
        self.groupBox_migratedImagePlot.setTitle(_translate("MainWindow", "Imagen migrada"))
    ...
    def enableProcessing(self):
        ...
        self.pushButton_backgroundSubstraction.setEnabled(enabled)
    ...
    def buscarRutaMediciones(self, MainWindow):
        ...
        if (directory[:-1] + "\\Time\\" in glob(directory + "*/")):
            self.lanzarMensajeError(
                "La carpeta seleccionada ya contiene una carpeta con mediciones en el dominio del tiempo. Elimínela si desea nuevamente ejecutar IFFT en las muestras.")
    ...
    def execBackgroundSubstraction(self, MainWindow):
        file = self.rawFilePath
    ...
    def execAscanPlot(self, MainWindow):
        try:
            ...
            self.lanzarMensajeError(
                "Los valores suministrados para las coordenadas exceden la posición máxima en " + os.path.basename(
                    file) + ". Por favor, intente con valores expaciales menores.")
        except Exception as ex:
            self.lanzarMensajeError("Ha ocurrido un error procesando el archivo, por favor intente de nuevo.")
            print(file)
            template = "An exception of type {0} occurred. Arguments:\n{1!r}"
    ...
    def execMigratedImagePlot(self, MainWindow):
        file = self.rawFilePathPlot
