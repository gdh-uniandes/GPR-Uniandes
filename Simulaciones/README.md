...
**[GSSI:](https://github.com/gdh-uniandes/GPR-Uniandes/blob/main/Simulaciones/gprMax/GSSI/) Simulación de la antena GSSI 

Además, en cada directorio de simulación, se encuentra un archivo con extensión:
